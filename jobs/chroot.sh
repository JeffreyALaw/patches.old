...
docker run -v "$(pwd)"/patches:/home/jlaw/jenkins/workspace/$TARGET/patches --privileged 172.31.0.149:5000/gcc-chroot-$TARGET ls /home/jlaw/jenkins/workspace/$TARGET/patches/jobs
